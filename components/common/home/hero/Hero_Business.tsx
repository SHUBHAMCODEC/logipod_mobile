    ...
    return (
        <div className="w-full flex flex-col items-center relative z-50">
            <AnimatePresence mode="wait">
                {step === "initial" && (
                    <motion.div key="initial" variants={stageVariants} initial="hidden" animate="visible" exit="exit" className="w-full max-w-4xl flex flex-col items-center text-center relative px-4 pt-16 md:pt-16">
                        <CloseButton />
                ...
                {step === "selection" && (
                    <motion.div key="selection" variants={stageVariants} initial="hidden" animate="visible" exit="exit" className="w-full max-w-5xl flex flex-col px-4 md:px-6 relative pt-16 md:pt-16">
                ...
                {step === "sub-selection" && selectedCategory && (
                    <motion.div key="sub-selection" variants={stageVariants} initial="hidden" animate="visible" exit="exit" className="w-full max-w-4xl flex flex-col px-4 md:px-6 relative pt-16 md:pt-16">
                        <CloseButton />
