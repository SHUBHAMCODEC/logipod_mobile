                ...
                <AnimatePresence mode="wait">
                    {activeSection === "none" && hoveredSection === "none" ? (
                        ...
                        >
                            ...
                            ========================================= */}
                            <div className="md:hidden w-full h-[110px] flex items-end justify-end px-4 shrink-0 z-[260]">
                                <motion.button
                                    initial={{ scale: 0.8, opacity: 0 }}
                                    animate={{ scale: 1, opacity: 1 }}
                                    whileTap={{ scale: 0.9 }}
                                    onClick={() => { setActiveSection("none"); setHoveredSection("none"); }}
                                    className="w-10 h-10 rounded-full border border-white/30 bg-black/50 text-white flex items-center justify-center backdrop-blur-md mb-2"
                                >
                    ...
                    {bottomLinks.map((item) => {
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                                className="relative group flex flex-col items-center gap-1 cursor-pointer shrink-0 py-2"
                            >
                                <motion.div
                                    animate={{
                    ...
                    {bottomLinks.map((item) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="relative flex flex-col items-center gap-0 cursor-pointer shrink-0 py-2 snap-center min-w-[110px] max-[360px]:min-w-[100px]"
                            >
                                <motion.div
                                    animate={{
                                        scale: isActive ? 1.2 : 0.9,
