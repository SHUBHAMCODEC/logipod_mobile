...
const Hero = () => {
    ...
    return (
        <div className="relative h-screen sm:h-[100dvh] w-full flex flex-col items-center justify-between overflow-hidden">
            ...
            ========================================= */}
            <div className="hidden md:block relative z-30 w-full h-[150px] pb-8 px-12 shrink-0 mb-0">
            ...
            ========================================= */}
            <div className="block md:hidden relative z-30 w-full h-[110px] sm:h-[130px] pb-6 px-4 shrink-0 mb-20 sm:mb-16">
