...
const cardsData = [
  { title: "Coverage", desc: "Pan-India highway network" },
  { title: "Speed", desc: "Express delivery, guaranteed" },
  { title: "Compliance", desc: "E-Way Bill zero-error filing" },
  { title: "Reliability", desc: "Dedicated truck, no co-load" },
  { title: "Visibility", desc: "Live GPS tracking, 24/7" }
];

const keywords = cardsData.map(card => `${card.title} - ${card.desc}`);

const headerHeadings = [
  "India's FTL Network Leader",
  "Highway Logistics Mastery",
  "Dedicated Truck Operations",
  "Advanced GPS Fleet Tracking",
  "Seamless Road Freight"
];
