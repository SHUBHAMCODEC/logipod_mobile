...
const strengths = [
  ...
  },
  {
    ...
    description: "Established partnerships across major ports and international trade routes.",
    icon: Globe2,
  },
  {
    title: "Speed & Efficiency",
    description: "Optimized workflows enabling faster turnaround and reduced delays.",
    icon: Zap,
  },
  {
    title: "Reliability & Trust",
    description: "Proven track record of safe, secure, and on-time deliveries.",
    icon: ShieldCheck,
  },
  {
    title: "Expertise & Compliance",
    description: "Deep understanding of global trade regulations and documentation standards.",
    icon: GraduationCap,
  },
];
    ...
    <section className="py-32 bg-[#FAF5EE] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          >
            Our Strengths That <br />
            Drive <span className="text-[#F26341]">Global Trade</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Built on experience, powered by precision, and trusted across international markets.
          </motion.p>
        </div>
